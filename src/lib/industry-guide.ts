...
export const INDUSTRIES: Record<IndustryKey, IndustryGuide> = {
  ...
  tech:         { key:'tech',         name:'Technology / SaaS',        color:'#6b9fff', display:'Barlow Condensed',  body:'Inter',       data:'JetBrains Mono',  palette:['#3b82f6','#05080f','#93c5fd','#6480a8','#eff6ff'], transitions:['glitch','zoom-passage','reveal-stagger'],              tone:'Ship fast, show proof. Data-backed claims, live metrics on every slide. The interface IS the pitch.',                                            avoid:['Serif-heavy decks','Warm gold palettes','Slow ceremonial transitions','Decorative scripts','Generic AI cliché (dark + purple-blue gradient + glowing orbs)','Glassmorphism / frosted panels as primary aesthetic','Robotic / futuristic visual metaphors unless the brand explicitly uses them'] },
